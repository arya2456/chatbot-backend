...
# Use environment variable if available, otherwise fallback (for safety)
...
# --- EMBEDDING HELPER (FIXED MODEL) ---
def get_embedding(text: str, task_type: str = "retrieval_document"):
    # Using the STABLE model compatible with 768 dimensions
...
@app.get("/")
def home(): return {"status": "FC Brain Active v5 (Stable)"}
